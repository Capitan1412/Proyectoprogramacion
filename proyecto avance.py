...
from math import log
        ...
        def calcular_perdidas(materiales, material_elegido, diametro, longitud, velocidad, densidad, viscosidad):
            ...
            if reynolds < 2000:
                ...
                factor_friccion = (1 / (-1.8 * log((6.9 / reynolds) + ((rugosidad / (3.7 * diametro)) ** 1.11)))) ** 2
        ...
        def generar_grafica_comparativa(material1, material2, diametro, longitud, velocidad, densidad, viscosidad):
            ...
            for velocidad in velocidades:
                for material in [material1, material2]:
                    perdidas = calcular_perdidas(materiales, material, diametro, longitud, velocidad, densidad, viscosidad)
                    perdidas_materiales[material].append(perdidas)

            # Gráfico comparativo de pérdidas por fricción
            plt.figure(figsize=(10, 6))
            plt.plot(velocidades, perdidas_materiales[material1], label=material1.capitalize())
            plt.plot(velocidades, perdidas_materiales[material2], label=material2.capitalize())
        ...
        if __name__ == "__main__":
            ...
            # Cálculo de pérdidas
            perdidas1 = calcular_perdidas(materiales, material1_elegido, diametro_tuberia, longitud_tuberia,
                                          velocidad_flujo, densidad_fluido, viscosidad_fluido)
            perdidas2 = calcular_perdidas(materiales, material2_elegido, diametro_tuberia, longitud_tuberia,
                                          velocidad_flujo, densidad_fluido, viscosidad_fluido)
